...
(function () {
	...
	Canvas.Element.prototype._initEvents = function() {
		YAHOO.util.Event.on(this._oElement, 'touchstart', this.onMouseDown, this, true);
		YAHOO.util.Event.on(this._oElement, 'touchend', this.onMouseUp, this, true);
		YAHOO.util.Event.on(this._oElement, 'touchmove', this.onMouseMove, this, true);
